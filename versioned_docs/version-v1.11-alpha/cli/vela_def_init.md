...
```
  ...
  -l, --lang string            Specify the language of the definition. Valid options: cue, go (default "cue")
  ...
  -t, --type string            Specify the type of the new definition. Valid types: component, policy, trait, workflow-step, workload
```
