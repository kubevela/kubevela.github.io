...
当然，还有更多。欢迎查看边栏中的 [选择待交付组件](./end-user/components/helm) 章节来阅读关于部署各种类型的详细文档。如果你需要的话，你还可以在 KubeVela 中添加自己的组件类型。
...
如果你想了解 KubeVela 所支持的所有运维特征，欢迎查看边栏中的 [绑定运维特征](./end-user/traits/ingress) 章节，同样的，KubeVela 允许你非常容易的在平台中添加自己的运维特征。
