...
![alt](../../../../../docs/resources/kubevela-net/images/1.3/dex-addon.png)

开启完毕后，我们还需要更新一下 VelaUX 插件，打开其 Dex 选项。同样，我们在插件列表中找到 VelaUX，进行更新：

![alt](../../../../../docs/resources/kubevela-net/images/1.5/enable-dex-in-velaux.png)
...
![alt](../../../../../docs/resources/kubevela-net/images/1.3/intergration.png)
...
![alt](../../../../../docs/resources/kubevela-net/images/1.3/ldap1.png)

如果你的 LDAP 没有提供匿名身份验证访问，那么你还需要打开高阶参数，填写 BindDN 和 BindPW，Connector 将使用这些信息进行用户的搜索。

![alt](../../../../../docs/resources/kubevela-net/images/1.3/ldap2.png)
...
![alt](../../../../../docs/resources/kubevela-net/images/1.5/platform-setting.jpg)
...
![alt](../../../../../docs/resources/kubevela-net/images/1.3/dex-login.png)

你可以选择使用 GitHub 或者 LDAP 进行登录。进行选择后，授权此次登录：

![alt](../../../../../docs/resources/kubevela-net/images/1.3/dex-grant-access.png)
