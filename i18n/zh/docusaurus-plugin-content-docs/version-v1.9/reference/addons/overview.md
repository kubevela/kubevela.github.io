...
* [Mysql Exporter](../../../../../../versioned_docs/version-v1.9/reference/addons/mysql-exporter.md): Prometheus exporter for MySQL server metrics.
...
* [ChartMuseum](../../../../../../versioned_docs/version-v1.9/reference/addons/chartmuseum): An open-source and easy to deploy Helm Chart Repository server.

## SaaS Workload

* [netlify](../../../../../../versioned_docs/version-v1.9/reference/addons/netlify): Netlify is a SaaS platform that can serve website especially for frontend service, it provides free allowances that was pretty cool to be used for demo and test.
