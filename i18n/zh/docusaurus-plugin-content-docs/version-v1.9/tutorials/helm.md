...
- Repo URL: 仓库地址，基于不同的仓库类型填写仓库地址，这里我们填写：[https://charts.bitnami.com/bitnami](https://charts.bitnami.com/bitnami)。另外，如果你在 [配置集成](../how-to/dashboard/config/helm-repo.md) 里配置了 helm 仓库，这里可以直接在下拉框中进行选择。
