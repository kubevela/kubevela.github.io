...
Please check the [Generate Forms from Definitions](/docs/administrator/openapi-v3-json-schema) guide for more detail of using this schema to render GUI forms. 
