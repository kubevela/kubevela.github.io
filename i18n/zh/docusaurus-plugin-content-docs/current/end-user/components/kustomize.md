...
描述一个 kustomize ，来自 Git 仓库、OSS bucket。
...
上面的示例中，Application 中名为 bucket-comp 的组件交付了一个来自 endpoint 为 oss-cn-beijing.aliyuncs.com 的 OSS bucket definition-registry 的 kustomize。kustomize.yaml 所在路径为 ./app/prod/
