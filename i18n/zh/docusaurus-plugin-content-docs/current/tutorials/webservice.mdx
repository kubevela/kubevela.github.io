...
如果你需要部署来自私有镜像仓库的镜像，请先进行镜像仓库配置，参考：[私有镜像仓库配置](../how-to/dashboard/config/image-registry.md)
...
![set webservice application](../../../../../docs/resources/kubevela-net/images/1.4/create-webservice.jpg)
...
* 了解 [组件参考手册](../end-user/components/references.md#webservice)查看更多字段说明。
* 了解 [运维特征参考手册](../end-user/traits/references.md)查看适用的运维特征功能。
* 了解 [多集群交付](../case-studies/multi-cluster.md)，学习如何将容器镜像部署到多集群、多环境中。
