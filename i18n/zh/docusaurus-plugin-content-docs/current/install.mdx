...
你需要在 KubeVela 图表之前安装 cert-manager。
...
这个安装步骤是可选的，如果你想将 [Helm Chart](https://helm.sh/)  注册为 KubeVela 功能，这是必需的。
...
你可以从其[官方网站](https://github.com/fluxcd/flux2)上安装整个 flux2，也可以安装由 KubeVela 提供的最少零件的图表：
...
>
> 新版 MacOS 在运行你下载的没有使用苹果开发者密钥的软件方面更加严格。我们还没有支持 KubeVela。
