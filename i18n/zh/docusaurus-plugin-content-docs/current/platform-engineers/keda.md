...
> 在继续之前，请确保你已了解 [Definition Objects](definition-and-templates.md) 和 [Defining Traits with CUE](/docs/cue/trait.md) 的概念。
...
> 请查看 [Defining Trait with CUE](../cue/trait.md) 部分，以获取有关 CUE 模板的更多详细信息。
