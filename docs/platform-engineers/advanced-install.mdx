...
## Install KubeVela with api-server

```
helm install --create-namespace -n vela-system kubevela kubevela/vela-core --version 1.1.0-nightly-build --set apiServer.enabled=true --wait
```
