...
You can refer to scenario docs such as [Provision cloud resources](../../tutorials/cloud-resources-orchestration#provision-cloud-resources) for more real use cases.
