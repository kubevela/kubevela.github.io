...
By default, velaux didn't have any exposed port, If installing it locally, you can view it by:
...
If you installing it in remote node, please refer to [VelaUX addon docs](./reference/addons/velaux) for more advanced installation ways.
