...
> For upgrading existing KubeVela, please read the [upgrade guide](./advanced-install.md#upgrade).
...
3. Install KubeVela
    ...
    You can also [install it with `cert-manager`](./advanced-install.md#install-kubevela-with-cert-manager).
