...
### Properties
 ...
 kubelet_config | Node kubelet configuration. See [GKE Node System Config](https://cloud.google.com/kubernetes-engine/docs/how-to/node-system-config#kubelet-options) for details. | `\{map(any)\}` | false |  
