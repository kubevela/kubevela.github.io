...
1. [Local machine](#local): Install in a local machine.
...
:::info
VelaD helps install Vela CLI, which requires administrator.
:::

<details>
<summary>How to start powershell with administrator privilege</summary>
